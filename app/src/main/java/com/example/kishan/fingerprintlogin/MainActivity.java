...
public class MainActivity extends AppCompatActivity implements FingerPrintAuthCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!trueFalse)
        {
            textView.setText("Please Connect your phone to ITLION wifi");
    ...
    class BackgroundTask extends AsyncTask<String,Void,String>
    {
        ...
        protected void onPreExecute() {
            add_url = "Full URL to the backend file in server in my case php";
            //for exam:   https://000webhostapp.com/Fingerprint/Insert.php
        }
